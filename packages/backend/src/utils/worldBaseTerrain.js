...
/**
 * Basisterrein van de wereldkaart (vóór wegen naar tuinen).
 * Gebruikt voor validatie: moestuinen alleen op volledig gras, zonder water/bergen/bomen.
 */
...
function buildBaseTerrainMap() {
  ...
  [
    ...
    [15, 1], [16, 1], [15, 18], [16, 18], [1, 9], [30, 9],
...
const BASE_TERRAIN = buildBaseTerrainMap();
...
function isGardenSuitableCenter(cx, cy, terrainMap = BASE_TERRAIN) {
