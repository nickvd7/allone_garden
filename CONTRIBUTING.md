...
**Short path (English + Dutch):** [docs/QUICK_START.md](docs/QUICK_START.md) — clone, `bash start.sh`, MoSCoW for student teams, Jest + `verify:quick` + Playwright. Steam is **out of scope** and **off by default** (`npm run steam:disable` if you need to turn it off).
